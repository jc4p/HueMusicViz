...
namespace WinformsVisualization.Visualization
{
    public class LineSpectrum : SpectrumBase
    {
        ...
        public SpectrumPointData[] CreateSpectrumPoints(Size size)
        {
        ...
        public Complex[] CreateSpectrumPointsComplex(Size size)
        {
            if (!UpdateFrequencyMappingIfNessesary(size))
                return null;

            var fftBuffer = new Complex[(int)FftSize];

            SpectrumProvider.GetFftDataComplex(fftBuffer, this);
            return fftBuffer;
        }
